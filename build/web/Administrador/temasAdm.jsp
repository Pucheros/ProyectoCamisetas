<html><head>
        ...
        <link href="..\css\Administrador\temasAdm.css" rel="stylesheet" type="text/css">
    </head><body>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-3">
            ...
            <hr>
            <a class="btn btn-block btn-primary" href="../Temas">Ver Temas<br></a>
          </div>
          <div class="col-md-3">
            <img src="..\img\Administrador\theatre-masks.png" class="img-responsive img-rounded">
            <hr>
